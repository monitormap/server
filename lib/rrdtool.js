 ...
 * @param callback
 */
RRDTool.prototype.create = function (filePath,param, ds, rra,callback) {

  var args = ['create', filePath].concat(param).concat(ds).concat(rra);
 ...
 * @param callback
 */
RRDTool.prototype.update = function (filePath, time, values, callback) {
  if(time=='N')
  ...
  var args = ['update', filePath,'-t',template.join(':'), value];
